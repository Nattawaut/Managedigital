...
<section class="content"></br>
    ...
    <body>
        ...
        <button class="buttonON" name="subject" type="submit" form="LED_ON" value="SubmitLEDON">จ่ายไฟ</button>
        <button class="buttonOFF" name="subject" type="submit" form="LED_OFF" value="SubmitLEDOFF">ตัดไฟ</button>
        <!-- Bootstrap Switch -->
    </body>
